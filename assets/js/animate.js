...
$('document').ready(function(){
	$('<img src="../static/assets/images/logo.png">').appendTo(".logo").hide().delay(1000).fadeIn(1000);
	$('<img src="../static/assets/images/wavefade.png">').appendTo(".wave").hide().delay(100).fadeIn(900);
