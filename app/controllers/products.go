	...
	case "beautec":
		return &data{
			...
			"points": []string{
				...
				"Salt cell de-scaler, protector and prolongs cell lifespan.",
			...
			"howItWorks": "Beautec's® advanced Synertec formulation combines a blend of high performance polymers that utilize a complex mechanism of threshold inhibitor, crystal modification and sequestration to accomplish effective preventative and ongoing removal of mineral scales, deposits, stains, and scum on pool surfaces. Beautec's® execptional performance is due, in part, to its extreme chlorine stability..",
			"features": []string{
				"Provides superior scale, stain, and scum control Plus prevents hard silicate scales.",
				"Salt cell de-scaler and cleaner.",
